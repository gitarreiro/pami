...
This was the background motivation to develop a mobile application, in a biking context, that helps users to avoid damaged sections of roads or to detect and localize chuckholes.
	...
	% you have to write something here. only a piture does not tell anything. explain every step of the picture
    ...
    \textbf{Google Map}
    %this is wrong: not all features require it. recording for example works fine without a map
    ...
    %explain figure: every single figure, what it shows, ...
    ...
    %why is this picture here? where should it be?
    \begin{figure}[H]
	\centering
